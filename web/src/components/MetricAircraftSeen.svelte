<script>
    ...
    const resource = createPolledResource(`api/stats/seen/aircraft?tz=${encodeURIComponent(tz)}`, { refreshMs: 2000 });
</script>
{#if $resource.loading}
    <SkeletonMetrics />
...
{:else}
    <div class="p-2 stats stats-vertical lg:stats-horizontal bg-base-100 shadow-sm rounded-xl hover:shadow-md transition-all duration-200 w-full">
        <div class="stat">
            ...
            <div class="stat-value"><NumberFlow willChange={true} respectMotionPreference={false} value={$resource.data.hour_aircraft} /></div>
        ...
        <div class="stat">
            ...
            <div class="stat-title">Aircraft seen</div>
            <div class="stat-value"><NumberFlow willChange={true} respectMotionPreference={false} value={$resource.data.today_aircraft} /></div>
        ...
        <div class="stat">
            ...
            <div class="stat-title">Aircraft seen</div>
            <div class="stat-value"><NumberFlow willChange={true} respectMotionPreference={false} value={$resource.data.total_aircraft} /></div>
