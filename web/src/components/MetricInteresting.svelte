<script>
    ...
    const resource = createPolledResource(`api/stats/interesting/metrics?tz=${encodeURIComponent(tz)}`, { refreshMs: 2000 });
</script>
{#if $resource.loading}
...
{:else}
    <div class="p-2 stats stats-vertical lg:stats-horizontal bg-base-100 shadow-sm rounded-xl hover:shadow-md transition-all duration-200">
        <div class="stat">
            ...
            <div class="stat-value"><NumberFlow willChange={true} respectMotionPreference={false} value={$resource.data.hour_interesting} /></div>
        ...
        <div class="stat">
            ...
            <div class="stat-title">Interesting flights seen</div>
            <div class="stat-value"><NumberFlow willChange={true} respectMotionPreference={false} value={$resource.data.today_interesting} /></div>
        ...
        <div class="stat">
            ...
            <div class="stat-title">Interesting flights seen</div>
            <div class="stat-value"><NumberFlow willChange={true} respectMotionPreference={false} value={$resource.data.total_interesting} /></div>
